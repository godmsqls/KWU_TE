import './Chong_detailPage.css';
import { useNavigate, useParams } from 'react-router-dom';
import { useEffect, useState } from 'react';
import ReviewModal from '../components/ReviewModal';

function Chong_detailPage() {
  ...
  return (
    <div className="container">
      <div className="header_wrap">
        <div className="school">총학생회</div>
        <button className='back-button' onClick={() => navigate('/Chong_listpage')}>←</button>
      </div>
...
export default Chong_detailPage;